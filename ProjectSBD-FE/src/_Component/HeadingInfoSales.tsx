...
export default function HeadingInfoSales() {
    ...
    return (
        <div className="flex justify-between items-center gap-[2rem] h-full">
            <div className="bg-white p-[2rem] w-full rounded-[1rem] shadow-table-black flex items-center gap-[1rem]">
                <i className='bx bxs-user-check text-[6.5rem] text-[#9a9cfd] bg-' ></i>
                <div className="">
                    <p className="text-black font-[600]">
                        Total Staff
                    </p>
                    <p className="text-[3rem] font-[500]">
                        {data?.totalStaff}
                    </p>
