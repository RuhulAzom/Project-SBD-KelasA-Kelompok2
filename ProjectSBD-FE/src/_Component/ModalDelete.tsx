...
export default function ModalDelete({ data, setDelete }: { data: any, setDelete: any }) {
    return (
        <>
            {data.show &&
                <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center z-[200] bg-[#ffffff52] backdrop-blur-[6px]">
                    <div className="bg-white p-[2rem] rounded-[.8rem] flex flex-col gap-[.5rem] shadow-default-black">
